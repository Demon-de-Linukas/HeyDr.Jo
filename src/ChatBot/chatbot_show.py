...
# @bot.message_handler(commands=['chasdat', 'endasdaChat'])
    ...
    try:
        ...
        if 'ho are you' in message.text:
           ...
           # response = chattingBot.get_response(statment)
            bot.send_message(chatid, 'I am Dr. Jo, a chat bot of Städel Museum :-)')
            return
        ...
        elif message.text.upper() == 'NO' and \
                (get_user_cache(userid, 'knowInfo') == '2' or get_user_cache(userid, 'knowInfo') == '3'):
